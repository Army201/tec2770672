...
<section class="register create">
    <menu><a href="{{url('login/')}}">Login</a>
        <a href="javascript:;">Register</a>
    </menu>
    <form action="{{route('register')}}" method="post" enctype="multipart/form-data">
        @csrf
        <img src="{{asset('images/ico-user.svg')}}" id="upload"  alt="upload">
        ...
        <select name="gender">
            ...
            <option value="Binary" @if(old('gender') == 'Binary') selected @endif>Binary</option>
        </select>
